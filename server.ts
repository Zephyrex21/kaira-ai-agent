  ...
  wss.on("connection", async (clientWs) => {
    ...
    try {
      ...
      const baseInstructions = 
        ...
        "   - WEBSITE & SEARCH CONTROL: Use 'openWebsite' for named sites (youtube, gmail, google, github, chatgpt) or any URL. Use 'searchWeb' with an 'engine' of google/youtube/github/duckduckgo/bing to open search results in the default browser. Example: 'Search YouTube for AI News' -> searchWeb(query='AI News', engine='youtube').\n" +
        ...
        "   - SCREENSHOT: Use 'takeScreenshot' or 'saveScreenshot' if TECH asks you to capture or save what's on screen. For 'What error is showing?' or 'Read the visible text' style questions, rely on your live multimodal screen vision (section 9) while screen-share is on, rather than a screenshot tool.\n" +
        ...
        "11. BRIGHTNESS (V2):\n" +
        "   - Use 'brightnessUp', 'brightnessDown', 'setBrightness' when the user asks to change screen brightness. Respond naturally: 'Alright, I've turned up the brightness for you.' The user can also adjust this in the SETTINGS panel in the UI.\n" +
