 ...
 * entirely in the KAIRA browser tab.
 *
...
export class KairaWakeWordDetector {
  private recognition: SpeechRecognitionLike | null = null;
  private ctor: SpeechRecognitionCtor | null;
  private phrase = "hey kaira";
  ...
  start(opts: WakeWordOptions): boolean {
    ...
    this.phrase = (opts.phrase || "hey kaira").toLowerCase().trim();
  ...
  setPhrase(phrase: string): void {
    this.phrase = (phrase || "hey kaira").toLowerCase().trim();
  }
