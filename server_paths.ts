 ...
 * packaged Electron app launches the backend it sets KAIRA_DATA_DIR to a
 * writable folder under %APPDATA%\KAIRA, because the install directory
...
export const DATA_DIR: string = process.env.KAIRA_DATA_DIR || process.cwd();
